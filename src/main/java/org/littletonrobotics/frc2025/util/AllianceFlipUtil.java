...
import org.littletonrobotics.frc2025.FieldConstants6328;

public class AllianceFlipUtil {
  public static double applyX(double x) {
    return shouldFlip() ? FieldConstants6328.fieldLength - x : x;
  }

  public static double applyY(double y) {
    return shouldFlip() ? FieldConstants6328.fieldWidth - y : y;
  }
  ...
  public static boolean shouldFlip() {
    return !Constants6328.disableHAL
